        ...
        <div className='shadow rounded-xl'>
            ...
            <div className='p-3 flex flex-col gap-3'>
                ...
                <div className='flex justify-between items-center'>
                    ...
                    disabled={loading}>
                     {loading?<LoaderCircle className='animate-spin'/>:<PlayCircle />}Enroll Course</Button> :<Link href={'/workspace/edit-course/'+ course?.cid} > <Button size={'sm'} ><Settings/>Generate Course</Button> </Link>}
                </div>
            </div>
        </div>
    )
